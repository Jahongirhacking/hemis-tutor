...
import { useGenerateGpaSummaryMutation } from '@/services/chat';
...
import AppropriationChart from '../components/AppropriationChart';
...
const GpaResult: FunctionComponent<IAnalyzeResultProps> = props => {
  ...
  const subjectGrades = useMemo(
    () => subjectsList?.filter(s => s?.overallScore?.grade),
    [subjectsList]
  );
