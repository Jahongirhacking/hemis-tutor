...
const TutorLogo = ({ className, color }: { className?: string, color?: string }) => {
    ...
    return (
        ...
        >
            ...
            <span
                className={`text-xl font-bold transition-colors ${color ? color : themeColor === 'light' ? 'text-black' : 'text-white'}`}
            >
