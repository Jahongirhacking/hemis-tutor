...
export function HandbookSection({ handbookImage, handbookCover, handbookTexture }: HandbookSectionProps) {
  ...
  return (
    <section
      id="maqolalar"
      className="relative overflow-hidden rounded-[32px] border border-white/50 bg-white/60 p-[2px] shadow-card"
    >
      <div className="relative overflow-hidden rounded-[30px] bg-gradient-to-r from-[#5ce094] via-[#37b1d0] to-[#0f6ad9] p-6 text-white sm:p-10">
        ...
        <div className="relative z-10 flex flex-col gap-6 sm:flex-row sm:items-center">
          <div className="flex-1 space-y-4">
            ...
            <h3 className="text-3xl font-bold leading-snug sm:text-4xl">
