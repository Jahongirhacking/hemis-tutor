...
import DistrictsCard from './DistrictsCard';
import EducationFormCard from './EducationFormCard';
import GenderCard from './GenderCard';
import GeoLocationCard from './GeoLocationCard';
import { ExpandItem } from './interface';
import LivingStatusCard from './LivingStatusCard';
import PerformanceCard from './PerformanceCard';
import SocialCard from './SocialCard';
import StatisticsCard from './StatisticsCard';
import TerrainsCard from './TerrainsCard';
import TopAbsentCard from './TopAbsentCard';
  ...
  return (
    <Flex vertical gap={24} className="dashboard-stats">
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} lg={8}>
          <EducationFormCard {...{ COLORS, CustomTooltip, PRIMARY, isDark }} />
        </Col>
